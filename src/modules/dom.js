...
export default class DOM {
  ...
  getPrioritySelect = (priorityValue) => {
    ...
    if (priorityValue) {
      priorityBtns.forEach((button) => {
        if (
          button.textContent.trim() === priorityValue.toString().toUpperCase()
        ) {
  ...
  createTodoContainer = (todo) => {
    ...
    if (circle) {
      if (todo.completed) {
        ...
        itemContainer.querySelector(".text-container").style.textDecoration =
          "line-through";
      }
  ...
  setPriorityColor = (container, value) => {
    ...
    if (circle) {
      switch (value) {
        case "Low":
          circle.className = "circle low-priority";
          break;
        case "Medium":
          circle.className = "circle medium-priority";
          break;
        case "High":
          circle.className = "circle high-priority";
          break;
        default:
  ...
  addTask = (e) => {
    ...
    const newTodo = new Todo(
      todoTitleField.value.trim(),
      todoDescriptionField.value.trim(),
